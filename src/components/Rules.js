    ...
    render() {
        return (
            <div>
                ...
                <div>
                    <p>Chaque joueur commence dans l'écurie, <br /> à tour de rôle, les joueurs lancent le dé jusqu'à l'obtention d'un
                        six, ce qui leur permettra de sortir de l'écurie.<br /><br />
                        ...
                        il rejoue, sinon, il donne le dé au joueur suivant. <br /><br />
